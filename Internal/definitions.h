...
// C++ Standard Library
#ifdef COMMON_PLATFORM_CPP_STD
	#undef COMMON_PLATFORM_CPP_STD
#endif
#define COMMON_PLATFORM_CPP_STD 0
// POSIX
#ifdef COMMON_PLATFORM_POSIX
	#undef COMMON_PLATFORM_POSIX
#endif
#define COMMON_PLATFORM_POSIX 1
// Windows
#ifdef COMMON_PLATFORM_WINDOWS
	#undef COMMON_PLATFORM_WINDOWS
#endif
#define COMMON_PLATFORM_WINDOWS 2
